...
export const addNewLoanV11 = `WITH
  inserted_refLoan AS (
    INSERT INTO
      adminloan."refLoan" (
        "refVenderId",
...
export const addNewLoan = `WITH
  ...
  repayment_input AS (
    SELECT
      ...
      TO_TIMESTAMP($7, 'YYYY-MM-DD"T"HH24:MI:SS.MS"Z"') AS repayment_start_date,
      CASE
        WHEN ir."refProductDurationType" = 1 THEN TO_TIMESTAMP($7, 'YYYY-MM-DD"T"HH24:MI:SS.MS"Z"') + INTERVAL '1 month'
        WHEN ir."refProductDurationType" = 2 THEN TO_TIMESTAMP($7, 'YYYY-MM-DD"T"HH24:MI:SS.MS"Z"') + INTERVAL '7 days'
        WHEN ir."refProductDurationType" = 3 THEN TO_TIMESTAMP($7, 'YYYY-MM-DD"T"HH24:MI:SS.MS"Z"') + INTERVAL '1 day'
        ELSE TO_TIMESTAMP($7, 'YYYY-MM-DD"T"HH24:MI:SS.MS"Z"')
      END AS payment_date
    FROM
      inserted_refLoan ir
  ),
